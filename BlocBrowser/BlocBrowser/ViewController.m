...
- (void) updateButtonsAndTitle {
    ...
    [self.awesomeToolbar setEnabled:[self.webView isLoading] forButtonWithTitle:kWebBrowswerStopString];
    [self.awesomeToolbar setEnabled:[self.webView isLoading] && self.webView.URL forButtonWithTitle:kWebBrowswerRefreshString];
...
- (void) floatingToolbar: (AwesomeFloatingToolbar *)toolbar didSelectButtonWithTitle:(NSString *)title {
    ...
    } else if ([title isEqual:kWebBrowswerStopString]) {
        [self.webView stopLoading];
    } else if ([title isEqual:kWebBrowswerRefreshString]) {
        [self.webView reload];
    }
}
